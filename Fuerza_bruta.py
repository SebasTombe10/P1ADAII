...
for cms in E:
    estudiante = cms[0]  # Obtiene el primer elemento del par (e.g., "e1")
    asignaturas = globals()[cms[1]]  # Obtiene la sublista correspondiente (e.g., ms1)
    matriz.append([estudiante,asignaturas])
